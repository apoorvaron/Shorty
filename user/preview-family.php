...
-->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" value="admin@gmail.com"
                                            id="example-text-input" disabled>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="example-email-input" class="col-sm-2 col-form-label">Membership
                                        Type</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label for="example-url-input" class="col-sm-2 col-form-label">Membership
                                        Date</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" type="url" value="04-02-2022"
                                            id="example-url-input">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-tel-input" class="col-sm-2 col-form-label">Membership
                                        Fee</label>
                                ...
                                <div class="form-group row">
                                    <label for="example-password-input" class="col-sm-2 col-form-label">BSC
                                        interested</label>
                                    <div class="col-sm-10">
                                        <select class="form-control">
                                            <option>Select</option>
                                ...
                                <div class="form-group row">
                                    <label for="example-datetime-local-input" class="col-sm-2 col-form-label">BYC
                                        interested</label>
                                    <div class="col-sm-10">
                                        <select class="form-control">
                                            <option>Select</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" value="Salt lake, Kolkata"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" value="West Bengal"
                                ...
                                <div class="col-md-12 text-center">
                                    <div class="form-group mb-0">
                                        <div>
                                            ...
                                            <a href="../thankyou.php"><button type="reset"
