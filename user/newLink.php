                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="linkIsFor" name="linkIsFor"
                                                    required placeholder="Link is for" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class=" form-control col-md-12">
                                        <span class="form-group">
                                            ...
                                            <span><input type="text" onkeypress="return blockSpecialChar(event)"
                                                    ...
                                                    style="border:0px;padding-left:0px;;max-width: 50%;" required
                                        ...
                                        <div class="col-md-6 text-center">
                                            <div class="form-group mb-0">
                                                <div>
                                                    ...
                                                    <button class='btn btn-primary new' type='button' hidden
                                                        id="previewBtn" data-toggle='modal' data-target='#myModal'
