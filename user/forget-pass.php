        ...
        <div class="card">
            <div class="card-body">
                ...
                <h3 class="text-center mt-0">
                    <a href="./forget-pass.php" class="logo logo-admin"><img src="../assets/images/forget.webp"
                ...
                <div class="p-3">
                    ...
                    <form class="form-horizontal" method="POST">
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <input class="form-control" type="email" id="email" required name="email"
                                    placeholder="Enter your Email" aria-label="Email" aria-required="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group text-center row m-t-20">
                            <div class="col-12">
                                <button class="btn btn-danger btn-block waves-effect waves-light btn-new" id="submit"
                                    name="submit" type="submit">Send Email</button>
                            </div>
                        </div>
