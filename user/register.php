    ...
    <script>
        ...
        function addInclude() {
            includeDiv.innerHTML = `
                                    <div class="col-12" style="margin-left: 0%; padding: 20px;">
                                        <ul style="color:grey; display:flex ;flex-direction:column; justify-content: center; padding-left: 20px; margin-bottom: 0px;">
