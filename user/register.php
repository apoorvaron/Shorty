                ...
                <div class="p-3">
                    ...
                    <form class="form-horizontal" method="POST" action='./register.php' enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <input class="form-control" type="email" style="border-radius:3px" required name="email" id="email" placeholder="Email">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <div class="input-group">
                                    <input type="password" class="form-control " style="border-radius:3px" id="password" required minlength="8" name="password" placeholder="Password" onblur="removeInclude()" onfocus="addInclude()">
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                <div class="input-group">
                                    <input type="password" class="form-control " style="border-radius:3px" id="cnfrmPass" required minlength="8" name="cnfrmPass" placeholder="Confirm Password">
                                    <div class="input-group-append">
                        ...
                        <div class="form-group row d-flex flex-col">
                            <div class="col-12">
                                ...
                                <div class="uplodInputFileds form-control p-0 h-full">
                                    <input data-parsley-type="file" type="file" style="border-radius:3px" class="file-upload" name="UploadImage" />
                                    <span class="custom-file-upload" style="background-color: #0d42ff">Choose File</span>
                        ...
                        <div class="form-group text-center row m-t-20">
                            <div class="col-12">
                                <button class="btn  btn-block waves-effect waves-light" style="background-color: #0d42ff;border-radius:5px; color:white; border: 1px solid #0d42ff;" id="submit" name="submit" type="submit">Register</button>
                            </div>
                        </div>
                        <div class="form-group m-t-10 mb-0 row">
                            <div class="col-sm-7 m-t-20">
                                <a href="../" class="link"><i class="mdi mdi-arrow-left-bold"></i> &nbsp; Home Page</a>
                            </div>
                            <div class="col-sm-5 m-t-20">
                                <a href="./login" class="link" style="margin-left:78px"><i class="mdi mdi-account-circle"></i> &nbsp; Login </a>
                            </div>
                        </div>
                    </form>
                </div>
